...
using BackendDemo.Features.Articles;
using BackendDemo.IntegrationTests.Features.Comments;
using BackendDemo.IntegrationTests.Features.Users;
...
namespace BackendDemo.IntegrationTests.Features.Articles
{
    public class DeleteTests : SliceFixture
    {
        ...
        public async Task Expect_Delete_Article_With_Comments()
        {
            ...
            var createCommentCmd = new BackendDemo.Features.Comments.Create.Command()
            {
                Comment = new BackendDemo.Features.Comments.Create.CommentData()
                {
